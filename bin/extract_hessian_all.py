...
experiment_name = "2024-08-02_hawkeye-hands-hessian-features.csv"

def _engineer_hessian_features(img):
    ...
    glcm_pyfeats_features = {str(k)+'_wrinkles_pyfeats':v for k,v in zip(labels_mean, features_mean)}
